...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/conoyo6r8-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-2f1d5de5e5.3jtw.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-2f1d5de5e5.3jtw.p3.openshiftapps.com}
